...
(function(m, ma) {
	...
	function gc(a) {
		return(parseFloat(/*m.curCSS(a[0], "paddingLeft", true);*/$(a[0]).css("paddingLeft",true)) || 0) + (parseFloat(/*m.curCSS(a[0], "paddingRight", true);*/$(a[0]).css("paddingRight",true)) || 0)
	}

	function ic(a) {
		return(parseFloat(
			/*m.curCSS(a[0],"marginLeft", true);*/$(a[0]).css("marginLeft",true)) || 0) + (parseFloat(/*m.curCSS(a[0], "marginRight", true)*/$(a[0]).css("marginRight",true)) || 0)
	}

	function hc(a) {
		return(parseFloat(/*m.curCSS(a[0], "borderLeftWidth", true)*/$(a[0]).css("borderLeftWidth",true)) || 0) + (parseFloat(/*m.curCSS(a[0], "borderRightWidth", true)*/$(a[0]).css("borderRightWidth",true)) || 0)
	}
	...
	function jc(a) {
		return(parseFloat(/*m.curCSS(a[0], "paddingTop", true)*/$(a[0]).css("paddingTop",true)) || 0) + (parseFloat(/*m.curCSS(a[0], "paddingBottom", true)*/$(a[0]).css("paddingBottom",true)) || 0)
	}

	function Fb(a) {
		return(parseFloat(/*m.curCSS(a[0], "marginTop", true)*/$(a[0]).css("marginTop",true)) || 0) + (parseFloat(/*m.curCSS(a[0], "marginBottom", true)*/$(a[0]).css("marginBottom",true)) || 0)
	}

	function kc(a) {
		return(parseFloat(/*m.curCSS(a[0], "borderTopWidth", true)*/$(a[0]).css("borderTopWidth",true)) || 0) + (parseFloat(/*m.curCSS(a[0], "borderBottomWidth", true)*/$(a[0]).css("borderBottomWidth",true)) || 0)
	}
